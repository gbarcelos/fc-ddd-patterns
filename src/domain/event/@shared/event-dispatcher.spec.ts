...
import EnviaConsoleLogWhenCustomerAddressIsChangedHandler from "../customer/handler/envia-console-log-when-customer-address-is-changed.handler";
import EnviaConsoleLog1WhenCustomerIsCreatedHandler from "../customer/handler/envia-console-log1-when-customer-is-created.handler";
import EnviaConsoleLog2WhenCustomerIsCreatedHandler from "../customer/handler/envia-console-log2-when-customer-is-created.handler";
